...
import scooterTres from '@assets/jpeg/gallery-e110s-3.jpeg'
...
export const products: IProduct[] = [
  {
    ...
    alias: 'fugleman-ut10',
    completeDesciprtion:
      'El UT10 X Fugleman es un vehículo todoterreno robusto y fácil de utilizar. Haciendo justicia a su nombre, el Fugleman será siempre líder en el desempeño de cualquier tarea, la cual te resultará fácil y muy divertida de hacer. ',
    video: '/videos/fugleman.mp4',
    features: [
      'DIRECCIÓN ASISTIDA (EPS)',
      'WINCH, PEGADERO Y PUERTAS COMPLETAS',
  ...
  },
  {
    ...
    featuresImage: [
      ...
      },
      {
        ...
        titleFeatures: 'MAYOR COMODIDAD',
        featuresDescription:
          'El volante y el asiento ajustables contribuyen directamente a la máxima comodidad del conductor. El respaldo central plegable ofrece más funcionales.',
      },
      {
        src: epsVillain.src,
        titleFeatures: 'EPS INTELIGENTE',
        featuresDescription:
          'La Dirección Electrónica Asistida puede ser configurada instantáneamente a cualquiera de las tres opciones disponibles (standard, confort y sport).',
      },
    ],
    galleryImages: [
      {
      ...
      {
        src: villainCuatro.src,
        width: 300,
        height: 200,
      },
      {
        src: villainCinco.src,
        width: 300,
        height: 200,
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      'CABESTRANTE Y BOLA DE REMOLQUE',
  ...
  },
  {
    ...
    logo: logoSnarler.src,
    model: modelSnarler.src,
    features: [
      'MODELO BÁSICO',
      'VERSION LARGA',
      'DIRECCIÓN ASISTIDA',
      'DEPOSITO DE COMBUSTIBLE 23 LITROS',
  ...
  },
  {
    ...
    galleryImages: [
      ...
      {
        src: scooterCuatro.src,
        width: 300,
        height: 200,
      },
      {
        src: scooterCinco.src,
        width: 300,
        height: 200,
      },
      {
